...
│   └── plugins/
│       ├── marketplaces.json         # ccpm-owned registry of cloned marketplaces
│       ├── marketplaces/<name>/      # cloned marketplace repos (shared)
│       └── cache/<marketplace>/<plugin>/<version>/  # cached plugin trees (shared)
├── profiles/<name>/
│   ├── settings.json                 # materialized
│   ├── skills/<name>                 # symlink → share/skills/<name>
│   ├── plugins/
│   │   ├── installed_plugins.json    # ccpm writes (Claude Code-shaped v2)
│   │   ├── known_marketplaces.json   # ccpm writes
│   │   ├── marketplaces/<name>       # symlink → share/plugins/marketplaces/<name>
│   │   └── cache/<marketplace>/<plugin>/<version>  # symlink → share/plugins/cache/...
